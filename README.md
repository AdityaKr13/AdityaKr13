...
<h2 data-importer="text" align="center">🚀 Full Stack Developer | MERN Stack Specialist | Java (Spring Boot)</h2>

###

<p data-importer="text" align="left">💻 Passionate Full Stack Developer skilled in building scalable, high-performance web applications using the MERN stack (MongoDB, Express.js, React, Node.js) along with PostgreSQL 🐘 for robust relational data management.<br><br>🎨 On the frontend, I love crafting smooth, interactive UI/UX experiences using GSAP ✨ for animations and Three.js 🌐 for immersive 3D visuals — bringing designs to life beyond static pages.<br><br>⚙️ On the backend, I build efficient and secure APIs using Node.js, Express.js, and Java ☕ — with hands-on experience in Spring Boot 🍃 for building production-ready microservices and Hibernate 🗃️ for clean, efficient ORM-based database management. I primarily develop in IntelliJ IDEA 🧠, leveraging its powerful tooling for debugging, refactoring, and productivity.<br><br>📦 I also work with Docker 🐳 and Kubernetes ⛵ for containerization and orchestration — ensuring my applications are portable, consistent, and easy to deploy across environments.<br><br>🤖 Currently diving deep into AI & Generative AI principles to stay ahead of the curve and build intelligent, future-ready applications.</p>

###

<p data-importer="text" align="center">💡 Always exploring new technologies to turn ideas into incredible, scalable, real-world projects.<br>📫 Let's connect and build something amazing together!</p>
...
<div data-importer="socials" align="left">
  ...
  <a href="https://www.linkedin.com/in/aditya-1b4bab316/" target="_blank">
